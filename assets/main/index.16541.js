window.__require = function e(t, n, r) {
  ...
  CatmullRomSpline: [ function(require, module, exports) {
    ...
    var SubSegmentCount = 10;
    var Epsilon = .1;
    var MinimumKnotCount = 4;
    ...
    var Knot = function() {
      function Knot(position, emitTime) {
        ...
        this.emitTime = 0;
        this.subKnots = new Array(SubSegmentCount + 1);
    ...
    var CatmullRomSpline = function() {
      ...
      Object.defineProperty(CatmullRomSpline.prototype, "SegmentCount", {
        get: function() {
      ...
      CatmullRomSpline.prototype.Length = function() {
        if (0 === this.SegmentCount) return 0;
      ...
      CatmullRomSpline.prototype.GetPosition = function(marker, out) {
        ...
        if (0 === this.SegmentCount) return pos;
      ...
      CatmullRomSpline.prototype.GetTangent = function(marker, out) {
        var tangent = out || cc.Vec2.ZERO;
        if (0 === this.SegmentCount) return tangent;
        var subKnots = this.GetSegmentSubKnots(marker.segmentIndex);
      ...
      CatmullRomSpline.prototype.Parametrize = function(fromSegmentIndex, toSegmentIndex) {
        if (this.knots.length < MinimumKnotCount) return;
        var segmentCount = Math.min(toSegmentIndex + 1, this.SegmentCount);
        ...
        for (var i = fromSegmentIndex; i < segmentCount; ++i) {
      ...
      CatmullRomSpline.prototype.PlaceMarker = function(result, distance, from) {
        ...
        if (0 === segmentCount) return false;
        if (distance <= 0) {
        ...
        if (distance >= this.Length()) {
          var subKnots = this.GetSegmentSubKnots(segmentCount - 1);
      ...
      CatmullRomSpline.prototype.ComputeLength = function() {
        ...
        var length = 0;
        var n = this.SegmentCount;
        for (var i = 0; i < n; ++i) length += this.ComputeLengthOfSegment(i, 0, 1);
        return length;
      };
  ...
  SceneDrawingBoard: [ function(require, module, exports) {
    ...
    var SceneDrawingBoard = function(_super) {
      ...
      function SceneDrawingBoard() {
        ...
        _this._pingPong = 0;
        _this._colorIndex = 0;
        _this._colors = [ cc.Color.RED, cc.Color.GREEN, cc.Color.BLUE ];
        return _this;
      }
      SceneDrawingBoard.prototype.onLoad = function() {
        ...
        for (var _i = 0, _a = this.pingPongBuffer; _i < _a.length; _i++) {
          var sprite_1 = _a[_i];
          var renderBuff_1 = RenderBuff.CreateRederBuff(sprite_1.node.width, sprite_1.node.height);
          sprite_1.sizeMode = cc.Sprite.SizeMode.CUSTOM;
          sprite_1.spriteFrame = renderBuff_1.spriteFrame;
          this._renderBuffMap.set(sprite_1.node, renderBuff_1);
          var mat = sprite_1.getMaterial(0);
          var gfx = cc.gfx;
          null === mat || void 0 === mat ? void 0 : mat.setBlend(true, gfx.BLEND_FUNC_ADD, gfx.BLEND_ONE, gfx.BLEND_ZERO, gfx.BLEND_FUNC_ADD, gfx.BLEND_ONE, gfx.BLEND_ZERO, 4294967295, 0);
        }
        var ping = this.pingPongBuffer[0];
        var pong = this.pingPongBuffer[1];
        ping.enabled = false;
        pong.enabled = false;
      ...
      SceneDrawingBoard.prototype.update = function() {
        ...
        var B = points[1];
        var C = points[2];
        var ping = this.pingPongBuffer[this._pingPong];
        var isValid = true;
        var useBezier = true;
        var halfBezier = true;
        ...
        var mat = ping.getComponent(cc.Sprite).getMaterial(0);
        ...
        if (isValid) {
          var pong = this.pingPongBuffer[1 - this._pingPong];
          ping.enabled = true;
          pong.enabled = true;
          this._debug && (ping.node.color = this._colors[this._colorIndex]);
      ...
      SceneDrawingBoard.prototype.TouchPosToPassPos = function(pos) {
        var node = this.pingPongBuffer[this._pingPong].node;
      ...
      SceneDrawingBoard.prototype.OnChangeWidthEnded = function(e) {
        var w = parseInt(e.string);
        var mat = this.board.getComponent(cc.Sprite).getMaterial(0);
        mat.setProperty("u_shift", w);
      };
      SceneDrawingBoard.prototype.OnSliderChange = function(e) {
        var v = 10 * e.progress;
        var mat = this.board.getComponent(cc.Sprite).getMaterial(0);
        mat.setProperty(e.node.name, v);
      };
      SceneDrawingBoard.prototype.OnToggleDefine = function(e) {
        this.RedefineBoardMaterial();
      };
      SceneDrawingBoard.prototype.RedefineBoardMaterial = function() {
        var mat = this.board.getComponent(cc.Sprite).getMaterial(0);
      ...
      __decorate([ property([ cc.Sprite ]) ], SceneDrawingBoard.prototype, "pingPongBuffer", void 0);
  ...
  SceneGraphicsDrawingBoard: [ function(require, module, exports) {
    ...
    var SceneGraphicsDrawingBoard = function(_super) {
      ...
      SceneGraphicsDrawingBoard.prototype.OnBoardTouchEnd = function() {
        ...
        this.trailRenderer.node.active && console.log("----- vcount: " + this.trailRenderer._a_vertices.length);
        this._debug && console.log("---------------------------- end ------------------------");
      };
    ...
    var SceneLoad = function(_super) {
      ...
      SceneLoad.prototype.Redirect = function() {
        ...
        if (search) {
          ...
          var gameName = param.get("game");
          if (gameName) {
            window.location.assign("./games/hexapipe/index.html");
            return true;
          }
          var sceneName = param.get("scene");
          if (sceneName) return cc.director.loadScene(sceneName);
        }
        return false;
      };
  ...
  SceneXOR: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "b6c99XDlk5GmoSJz1P0HJXz", "SceneXOR");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var _a = cc._decorator, ccclass = _a.ccclass, property = _a.property;
    var SceneXOR = function(_super) {
      __extends(SceneXOR, _super);
      function SceneXOR() {
        var _this = null !== _super && _super.apply(this, arguments) || this;
        _this.container = null;
        return _this;
      }
      SceneXOR.prototype.start = function() {
        var gfx = cc.gfx;
        for (var _i = 0, _a = this.container.children; _i < _a.length; _i++) {
          var c = _a[_i];
          var sprite = c.getComponent(cc.Sprite);
          var mat = sprite.getMaterial(0);
          null === mat || void 0 === mat ? void 0 : mat.setBlend(true, gfx.BLEND_FUNC_ADD, gfx.BLEND_ONE_MINUS_DST_COLOR, gfx.BLEND_ONE_MINUS_SRC_COLOR, gfx.BLEND_FUNC_ADD, gfx.BLEND_ONE_MINUS_DST_ALPHA, gfx.BLEND_ONE_MINUS_SRC_ALPHA, 0, 0);
          console.log("enter");
        }
      };
      __decorate([ property(cc.Node) ], SceneXOR.prototype, "container", void 0);
      SceneXOR = __decorate([ ccclass ], SceneXOR);
      return SceneXOR;
    }(cc.Component);
    exports.default = SceneXOR;
    cc._RF.pop();
  }, {} ],
  ...
  SplineTrailRendererAssembler: [ function(require, module, exports) {
    "use strict";
    cc._RF.push(module, "3569cPG7i1JeZ5HaqfQ4gFP", "SplineTrailRendererAssembler");
    "use strict";
    var __extends = this && this.__extends || function() {
      var extendStatics = function(d, b) {
        extendStatics = Object.setPrototypeOf || {
    ...
    var SplineTrailRendererAssembler = function(_super) {
      ...
      SplineTrailRendererAssembler.prototype.updateVerts = function(comp) {
        ...
        var vertices = comp._a_vertices;
        var width = comp._a_width;
        var dist = comp._a_dist;
        var vertexCount = vertices.length;
  ...
  SplineTrailRenderer: [ function(require, module, exports) {
    ...
    var SplineTrailRenderer = function(_super) {
      ...
      function SplineTrailRenderer() {
        ...
        _this.updateMeshEveryFrame = false;
        _this.headSegmentsToRedraw = 3;
        _this.fadeType = FadeType.None;
        _this.fadeLengthBegin = 5;
        _this.fadeLengthEnd = 5;
        _this._a_vertices = new CacheArray_1.CacheArray();
        _this._a_width = [];
        _this._a_dist = [];
        _this._fixedPointIndex = 0;
        _this._distTolerance = 4;
        _this._pointsDirty = false;
      ...
      SplineTrailRenderer.prototype.lateUpdate = function() {
      ...
      SplineTrailRenderer.prototype.RenderMesh = function() {
        ...
        0 === this.headSegmentsToRedraw ? spline.Parametrize(0, spline.SegmentCount - 1) : spline.Parametrize(spline.SegmentCount - this.headSegmentsToRedraw, spline.SegmentCount);
        var length = Math.max(spline.Length() - .1, 0);
        var quads = Math.floor(1 / segmentLength * length) + 1 - this._quadOffset;
      ...
      }) ], SplineTrailRenderer.prototype, "updateMeshEveryFrame", void 0);
...
}, {}, [ "SceneSDFFont", "SceneSDFPhysics", "SceneTestGraphics", "SceneSpriteMaskedAvatars", "AvatarAssembler", "AvatarSprite", "EqualScalingAssembler", "EqualScalingSprite", "SpriteMaskedAvatarAssembler", "SpriteMaskedAvatarSprite", "CAParser", "SceneCellularAutomata", "MovingBGAssembler", "MovingBGSprite", "SceneDrawingBoard", "SceneGraphicsDrawingBoard", "CacheArray", "CatmullRomSpline", "SplineTrailRenderer", "SplineTrailRendererAssembler", "GraphicsShowMesh", "SceneGraphics", "SmoothTrail", "SmoothTrailAssembler", "SmoothTrailImpl", "LayeredBatchingAssembler", "LayeredBatchingRootRenderer", "SceneLayeredBatchingScrollView", "SceneMetaBalls", "MetaBallsAssembler", "MetaBallsRenderer", "SceneParticlesBatching", "EDT", "EDTAA3", "SceneSDF", "FFTTextureGenerator2", "MusicVisualizer", "MusicVisualizerH5", "SceneVisualizeMusic", "SceneXOR", "NavigatorButton", "SimpleDraggable", "SceneLoad", "SceneTest", "SceneWelcome", "GTAssembler2D", "GTAutoFitSpriteAssembler2D", "GTSimpleSpriteAssembler2D" ]);